            ...
            <div className="min-h-screen relative">
                ...
                <div className="absolute inset-0 lg:hidden">
                    <div
                        ...
                        style={{ backgroundImage: `url(${heroImage})`, filter: 'blur(2px)', transform: 'scale(1.02)' }}
                    />
                    {/* dark overlay */}
                    ...
                    <div className="hidden lg:flex items-center justify-center p-12">
                        ...
                        >
                            ...
                            <div className="absolute inset-0 pointer-events-none">
                                <div className="absolute inset-0 rounded-2xl border border-white/6 backdrop-blur-sm" />
                            </div>
                            {/* vignette */}
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <motion.div variants={childVariants} className="flex items-center justify-between">
                                            <div className="flex items-center">
                                                <Checkbox
                                                    ...
                                                    disabled={processing}
                                                />
                                                <Label htmlFor="remember" className="ml-2 text-sm font-medium text-foreground">Remember me</Label>
                                            </div>
                                            {canResetPassword && (
                                                <TextLink href={route('password.request')} className="text-sm text-primary hover:underline transition-colors">
                                                    Forgot password?
                                                </TextLink>
                                            )}
                                        </motion.div>
                                        ...
                                        <motion.div variants={childVariants} whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                                            <Button type="submit" className="w-full font-semibold transition-all duration-300 hover:shadow-md" tabIndex={3} disabled={processing}>
                                    ...
                                    >
                                        ...
                                        <TextLink href={route('register')} tabIndex={4} className="hover:underline transition-colors">
                                            Create account
                                        </TextLink>
                                    </motion.div>
                                </motion.form>
